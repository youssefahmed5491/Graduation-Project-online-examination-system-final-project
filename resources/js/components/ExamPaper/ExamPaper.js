...
const ExamPaper = () => {
    ...
    useEffect(() => {
        if (users.modelquestions != null) {
            setArraylol(Array(displayquestions()[0].length).fill(1));
            setQuestionAnswer(Array(displayquestions()[0].length));
            setEgabat(Array(displayquestions()[0].length));
        }
    ...
    const handleNext = () => {
        ...
        if (ind > displayquestions()[0].length - 2) {
            console.log("lol");
            setInd(0);
            ind2 = 0;
            handleSquares(0);
    ...
    const handlePrevious = () => {
        ...
        setCheck(false);
        if (ind === 0) {
            setInd(displayquestions()[0].length - 1);

            ind2 = displayquestions()[0].length - 1;
            handleSquares(displayquestions()[0].length - 1);
        } else {
            setInd(ind - 1);
            ind2 = ind - 1;
            // let temp = [...arraylol];
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            {users.modelquestions != null &&
                                displayquestions()[0].map((user, index) => {
                                    return (
                                        <div
                                            key={index}
                                            className=""
